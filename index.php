    ...
    <nav class="col s12">
        <nav class="pink darken-3">
            <div class="nav-wrapper">
                <a href="#home" class="brand-logo">It's All in the Vix.!!!<img class="responsive-img" src="img/pic1.gif" /> </a>
...
<!-- start tabs -->
    ...
    <div id="home" class="onder col s12">
        ...
        <div class="row">
        <a href="#home" class="start"> <img class="responsive-img" src="img/pic1.gif"/></a>
        <a href="#about" class="start"> <img class="responsive-img" src="img/pic2.gif"/></a>
        <a href="#" class="start"> <img class="responsive-img" src="img/pic3.gif"/></a>
        </div>
        <div class="row center">
        <a href="#" class="start"> <img class="responsive-img" src="img/pic4.gif"/></a>
        <a href="#" class="start"> <img class="responsive-img" src="img/pic5.gif"/></a>
        </div>
    </div>
